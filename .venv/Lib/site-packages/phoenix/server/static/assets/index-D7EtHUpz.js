import{G as g,j as o,cH as h,ep as v,eq as y,er as x,l as r,c3 as z,es as a,r as w,o as P,et as k}from"./vendor-DhvamIr8.js";import{r as S,s as L}from"./vendor-arizeai-4fVwwnrI.js";import{L as C,g as j,r as R,h as E,i as I,F as D,j as A,P as T,k as F,M as t,l as _,D as G,n as M,E as O,o as N,p as q,q as V,s as W,t as d,v as B,w as $,x as H,y as K,z as U,B as J,C as Q,G as X,H as Y,I as Z,J as oo,K as ao,N as lo,O as ro,Q as co,U as go,V as eo,W as m,X as p,Y as u,Z as bo,_ as no,$ as io,a0 as so,a1 as to,a2 as mo,a3 as po,a4 as uo,a5 as fo,a6 as ho,a7 as vo,a8 as yo,a9 as xo,aa as zo,ab as wo,ac as Po,ad as ko,ae as So,af as Lo,ag as Co,ah as jo,ai as Ro,aj as Eo,ak as Io,al as Do,am as Ao,an as To,ao as Fo,ap as _o,aq as Go,ar as Mo,as as Oo,at as No,au as qo,av as Vo,aw as Wo,ax as n,ay as Bo,az as $o,aA as Ho,aB as Ko,aC as Uo,aD as Jo,aE as Qo}from"./pages-CPfaxiKa.js";import{fn as Xo,cV as Yo,S as Zo,fo as oa,fp as aa}from"./components-XAeml0-1.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-DRfFHb57.js";import"./vendor-shiki-CplrhwOk.js";import"./vendor-recharts-w6bSawXG.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))s(c);new MutationObserver(c=>{for(const e of c)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function f(c){const e={};return c.integrity&&(e.integrity=c.integrity),c.referrerPolicy&&(e.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?e.credentials="include":c.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function s(c){if(c.ep)return;c.ep=!0;const e=f(c);fetch(c.href,e)}})();const la=g`
  :root,
  .ac-theme {
...
`;function ma(){const{theme:l="dark"}=S();return o(h,{styles:g(ca,ra,l==="dark"?ga:ea,ba(l),la,na,ia,sa,ta,da)})}const pa=v(y(r(a,{path:"/",errorElement:o(n,{}),children:[o(a,{path:"/v1/*",element:o(z,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(C,{})}),o(a,{path:"/logout",element:o(j,{})}),o(a,{path:"/reset-password",element:o(E,{}),loader:R}),o(a,{path:"/reset-password-with-token",element:o(I,{})}),o(a,{path:"/forgot-password",element:o(D,{})}),o(a,{element:o(Ko,{}),loader:A,children:r(a,{element:o(Ho,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(T,{})}),o(a,{index:!0,loader:F}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(N,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(G,{}),loader:_})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(O,{}),loader:M,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"projects"},element:o(Z,{}),children:[o(a,{index:!0,element:o(q,{})}),r(a,{path:":projectId",loader:V,handle:{crumb:l=>l.project.name},element:o(Y,{}),children:[o(a,{index:!0,element:o(W,{})}),r(a,{element:o(X,{}),children:[o(a,{path:"traces",element:o(B,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o($,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(U,{}),children:o(a,{path:":sessionId",element:o(K,{}),loader:H})}),o(a,{path:"config",element:o(J,{})}),o(a,{path:"metrics",element:o(Q,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"dashboards"},element:o(go,{}),children:[o(a,{index:!0,element:o(ao,{}),loader:oo}),o(a,{path:"projects/:projectId",element:o(ro,{}),loader:lo,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(co,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(a,{index:!0,element:o(eo,{})}),r(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(so,{}),loader:m,children:[o(a,{index:!0,element:o(u,{}),loader:p}),o(a,{path:"experiments",element:o(u,{}),loader:p}),o(a,{path:"examples",element:o(io,{}),loader:bo,children:o(a,{path:":exampleId",element:o(no,{})})})]}),o(a,{path:"compare",element:o(mo,{}),loader:to,handle:{crumb:()=>"compare"}})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(po,{})}),o(a,{path:"spans/:spanId",element:o(fo,{}),loader:uo,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(a,{index:!0,element:o(vo,{}),loader:ho}),r(a,{path:":promptId",loader:yo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(Co,{}),children:[o(a,{index:!0,element:o(xo,{})}),o(a,{path:"versions",loader:zo,element:o(ko,{}),children:o(a,{path:":versionId",loader:wo,element:o(Po,{})})}),o(a,{path:"config",element:o(Lo,{}),loader:So})]}),o(a,{path:"playground",element:o(Ro,{}),loader:jo,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Eo,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Io,{}),handle:{crumb:()=>"support"}}),r(a,{path:"/settings",element:o(Vo,{}),handle:{crumb:()=>"settings"},children:[o(a,{path:"general",loader:Do,element:o(Ao,{}),handle:{crumb:()=>"general"}}),o(a,{path:"providers",loader:To,element:o(Fo,{}),handle:{crumb:()=>"providers"}}),o(a,{path:"models",loader:_o,element:o(Go,{}),handle:{crumb:()=>"models"}}),o(a,{path:"annotations",loader:Mo,element:o(Oo,{}),handle:{crumb:()=>"annotations"}}),o(a,{path:"data",element:o(qo,{}),handle:{crumb:()=>"data retention"},loader:No})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Wo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:Bo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_otel_id",loader:$o,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function ua(){return o(x,{router:pa})}function fa(){return o(Uo,{children:o(Xo,{children:o(ha,{})})})}function ha(){const{theme:l}=Yo();return o(L,{theme:l,mountGlobalStyles:!1,children:r(P.RelayEnvironmentProvider,{environment:Zo,children:[o(ma,{}),o(Jo,{children:o(oa,{children:o(Qo,{children:o(w.Suspense,{children:o(aa,{children:o(ua,{})})})})})})]})})}const va=document.getElementById("root"),ya=k.createRoot(va);ya.render(o(fa,{}));
